...
import Step1Asset from "../Assets/Step1Asset";
import Step2Asset from "../Assets/Step2Asset";
import Step3Asset from "../Assets/Step3Asset";
import Step4Asset from "../Assets/Step4Asset";
...
const Step = () => {
  ...
  return (
    ...
    >
      ...
      >
        <Grid item xs={6}>
          {stepSpec.stepOrder === 1 && <Step1Asset></Step1Asset>}
          {stepSpec.stepOrder === 2 && <Step2Asset />}
          {stepSpec.stepOrder === 3 && <Step3Asset />}
          {stepSpec.stepOrder === 4 && <Step4Asset />}
        </Grid>
        <Grid item xs={6}>
          <h1
            id="stepTitle"
